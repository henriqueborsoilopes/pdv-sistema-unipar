...
public class MainController extends JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setBackground(new java.awt.Color(222, 225, 225));
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cód", "Descrição", "Qtd", "Valor Unit", "Desconto", "Valor Total", "Excluir"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jButton3.setText("Imprimir (F3)");
        jButton3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("137,81");
        ...
        jButton6.setText("+ Novo lançamento (F1)");
        ...
        jButton5.setText("+ Novo pagamento (F4)");
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Forma", "Parcelas", "Valor total", "Excluir"
            }
        ));
        ...
        if (jTable3.getColumnModel().getColumnCount() > 0) {
            ...
            jTable3.getColumnModel().getColumn(3).setMinWidth(80);
